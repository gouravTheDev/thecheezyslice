...
<head>
    ...
    <title>Cheezy Slice Admin Login</title>
    ...
    <link href="{{ asset('css/login/css/sb-admin-2.min.css')}}" rel="stylesheet">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <img src="{{ asset('images/pizza-h.jpg')}}" style="width: 105%; height: 100%;">
                            </div>
                            <div class="col-lg-5 col-md-5 col-sm-12" style="padding-bottom: 20px;">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Cheezy Slice Admin Login</h1>
                                    </div>



                                    <form class="form-horizontal" action="{{url('post-login')}}" method="POST" id="logForm">
                                        {{ csrf_field() }}
